...
<body class="bg-light">
    ...
    <!-- Carousel -->
    <div class="container-fluid ph-lg-4 mt-4">
            ...
            while ($room_data = mysqli_fetch_assoc($room_res)) {
                ...
                <div class='card border-0 shadow' style='max-width: 350px; margin: auto;'>
                    ...
                    <div class='card-body'>
                        ...
                        <h6 class='mb-4'>$room_data[price] sums per night</h6>
            ...
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        ...
                        <h6 class="m-0 ms-2">USER NAME</h6>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur numquam beatae, quasi dolorem non suscipit officiis inventore repellat quas aliquid.</p>
                    <div class="rating">
                        <i class="bi bi-star-fill text-warning"></i>
                        <i class="bi bi-star-fill text-warning"></i>
                        <i class="bi bi-star-fill text-warning"></i>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="bg-white p-4 rounded mb-4 ">
                    ...
                    <?php
                    if ($contact_r['insta'] != '') {
                        echo   "<a href='$contact_r[insta]' class='d-inline-block mb-3'>
                    ...
                    <a href="<?php echo $contact_r['tg'] ?>" class="d-inline-block mb-3">
                        <span class="badge bg-light text-dark fs-6 p-2">
